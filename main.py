...
def load_vgg(sess, vgg_path):
    ...
    input_l = saved_graph.get_tensor_by_name(vgg_input_tensor_name)
    keep_prob = saved_graph.get_tensor_by_name(vgg_keep_prob_tensor_name)
    layer_3 = saved_graph.get_tensor_by_name(vgg_layer3_out_tensor_name)
    layer_4 = saved_graph.get_tensor_by_name(vgg_layer4_out_tensor_name)
    layer_7 = saved_graph.get_tensor_by_name(vgg_layer7_out_tensor_name)
...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, train_op, cross_entropy_loss = optimize(model, correct_label_tf, learning_rate_tf, num_classes)
